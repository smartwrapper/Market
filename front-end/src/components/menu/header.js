            ...
            <input id="quick_search" className="xs-hide" name="quick_search" placeholder="search item here..." type="text" />
              ...
              <BreakpointProvider>
                <Breakpoint l down>
                  ...
                  <div className='menu'>
                    ...
                    <div className="navbar-item">
                      <NavLink to="/ItemDetail/1" onClick={() => btn_icon(!showmenu)}>
                        Item Details
                      </NavLink>
                    </div>
                    <div className="navbar-item">
                      <NavLink to="/portfilo" onClick={() => btn_icon(!showmenu)}>
                        Portfilo
                      </NavLink>
                    </div>
                    <div className="navbar-item">
                ...
                <Breakpoint xl>
                  <div className='menu'>
                    ...
                    <div className="navbar-item">
                      <NavLink to="/home3" onClick={() => btn_icon(!showmenu)}>
                        Home
                      </NavLink>
                    </div>
                    <div className="navbar-item">
                      <NavLink to="/colection/1" onClick={() => btn_icon(!showmenu)}>
                        Portfilo
                      </NavLink>
                    </div>
                    {/*<div className="navbar-item">
              ...
              <div className='mainside'>
                <div className='connect-wal'>
                 <a aria-current="page" className="active" >Connect Wallet</a>
