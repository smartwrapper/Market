...
const NftMusicCard = ({ nft, audioUrl, className = 'd-item col-lg-3 col-md-6 col-sm-6 col-xs-12 mb-4', height, onImgLoad }) => {
    ...
    //     setVideo(player);
    // }
    if(nft.preview_image){
        var url=api.baseUrl + nft.preview_image.url;

    }else{
        var url=api.baseUrl + nft.preview_image;
    }
     const [playing, toggle,video] = useVideo1(url);
            ...
            <div className="nft__item m-0">
                ...
                <div className="nft__item_info">
                    ...
                    <div className="nft__item_action">
                        <span onClick={() => navigateTo(`ItemDetail/${nft.id}`)}>Place a bid</span>
                    </div>
