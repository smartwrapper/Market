                            ...
                            <div className="de-flex">
                                <div className="de-flex-col">
                                    <span onClick={()=> window.open("", "_self")}>
                                        <img alt="" className="f-logo d-1" src="/img/logo-black.png" />
                                        <img alt="" className="f-logo d-3" src="/img/logo-black.png" />
                                        <img alt="" className="f-logo d-4" src="/img/logo-black.png"  />
