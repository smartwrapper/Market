...
import ColumnNewRedux from '../components/custormComponents/ColumnNewRedux_1';
import Footer from '../components/footer';
import { createGlobalStyle } from 'styled-components';
import * as selectors from '../../store/selectors';
import { fetchAuthorList, } from "../../store/actions/thunks";
import { filterStatus } from "../../store/actions";
...
const [flagonSale,setFlagonSale] = React.useState({value:"buy_now",singleSelect:true});
const handleBtnClick = () => {
  ...
  setFlagonSale({value:"buy_now",singleSelect:true});
...
const handleBtnClick1 = () => {
  ...
  // document.getElementById("Mainbtn2").classList.remove("active");
  setFlagonSale({value:"has_offers",singleSelect:true});
...
useEffect(() => {
  ...
  dispatch(filterStatus(flagonSale));
}, [dispatch, authorId,flagonSale]);
